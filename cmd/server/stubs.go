...
func (nilUserRepo) FindByEmail(_ context.Context, _ string) (*model.User, error) {
	panic("not implemented")
}
func (nilUserRepo) FindByID(_ context.Context, _ string) (*model.User, error) {
	panic("not implemented")
}
...
func (nilRefreshTokenRepo) Create(_ context.Context, _ *model.RefreshToken) error {
	panic("not implemented")
}
func (nilRefreshTokenRepo) FindByTokenHash(_ context.Context, _ string) (*model.RefreshToken, error) {
	panic("not implemented")
}
func (nilRefreshTokenRepo) DeleteByTokenHash(_ context.Context, _ string) error {
	panic("not implemented")
}
func (nilRefreshTokenRepo) DeleteAllByUserID(_ context.Context, _ string) error {
	panic("not implemented")
}
...
func (nilAreaRepo) FindByID(_ context.Context, _ string) (*model.Area, error) {
	panic("not implemented")
}
...
func (nilProjectRepo) List(_ context.Context, _ string) ([]model.Project, error) {
	panic("not implemented")
}
func (nilProjectRepo) FindByID(_ context.Context, _ string) (*model.Project, error) {
	panic("not implemented")
}
...
func (nilTaskRepo) FindByID(_ context.Context, _ string) (*model.Task, error) {
	panic("not implemented")
}
...
func (nilSubtaskRepo) ListByTask(_ context.Context, _ string) ([]model.Subtask, error) {
	panic("not implemented")
}
func (nilSubtaskRepo) FindByID(_ context.Context, _ string) (*model.Subtask, error) {
	panic("not implemented")
}
...
func (nilUserPlanRepo) FindByUserID(_ context.Context, _ string) (*model.UserPlan, error) {
	panic("not implemented")
}
...
func (nilWebhookEventRepo) EventExists(_ context.Context, _ string) (bool, error) {
	panic("not implemented")
}
func (nilWebhookEventRepo) Save(_ context.Context, _ *model.WebhookEvent) error {
	panic("not implemented")
}
...
func (nilAISessionRepo) List(_ context.Context, _ string) ([]model.AISession, error) {
	panic("not implemented")
}
func (nilAISessionRepo) FindByID(_ context.Context, _ string) (*model.AISession, error) {
	panic("not implemented")
}
...
func (nilAIMessageRepo) ListBySession(_ context.Context, _ string) ([]model.AIMessage, error) {
	panic("not implemented")
}
...
func (nilAIUsageMonthlyRepo) Upsert(_ context.Context, _ *model.AiUsageMonthly) error {
	panic("not implemented")
}
func (nilAIUsageMonthlyRepo) FindByUserMonth(_ context.Context, _ string, _ time.Time) (*model.AiUsageMonthly, error) {
	panic("not implemented")
}
